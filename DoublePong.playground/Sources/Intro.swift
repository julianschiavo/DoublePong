...
public var isIntro:            Bool = prefs.object(forKey: "isIntro") != nil ? prefs.object(forKey: "isIntro") as! Bool : true
public var nextIntro:          Int = prefs.object(forKey: "nextIntro") != nil ? (prefs.object(forKey: "nextIntro") as! Int == 6 ? 6 : 1)  : 1
...
public extension Scene {
    ...
    public func introGame() {
        if (isIntro) {
            if nextIntro == 1 {
            ...
            } else if nextIntro == 2 { introTitle.stringValue = "Paddles"
                ...
                introProgress.increment(by: 1)
            } else if nextIntro == 4 { introTitle.stringValue = "Controls"
                ...
                introProgress.increment(by: 1)
            } else if nextIntro == 5 { introTitle.stringValue = "Begin"
                introDescription.stringValue    = "Just press the button below to begin!"
