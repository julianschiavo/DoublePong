...
public class Scene: SKScene, SKPhysicsContactDelegate {
    ...
    @objc public func pauseGame() {
        ...
        restartButton.isHidden  = gamePlaying ? false : true
    ...
    override public func didMove(to view: SKView) {
        ...
        topPaddle.position          = CGPoint(x: horizontalRan, y: frame.maxY - topPaddle.size.height)
        ...
        bottomPaddle.position       = CGPoint(x: horizontalRan, y: frame.minY + bottomPaddle.size.height)
        ...
        leftPaddle.position         = CGPoint(x: frame.minX + leftPaddle.size.width, y: verticalRand)
        ...
        rightPaddle.position        = CGPoint(x: frame.maxX - rightPaddle.size.width, y: verticalRand)
